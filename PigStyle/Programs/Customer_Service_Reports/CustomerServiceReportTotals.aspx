        ...
        <div id="container" dw-loading="modalOpen">
            <div id="header">
                ...
                <div class="text" style="text-align: center">
                    <h1>Customer Service Report - Totals</h1>
                </div>
            </div>
            <div id="breadcrumbs">
                ...
                <a href="/Programs/Customer_Service_Reports/CustomerServiceReportTotals.aspx">Totals Report</a>
            </div>
            <div id="main">
                <div id="nav">
                ...
                <div id="content">
                    ...
                    <div class="onerow" style="padding-top: 1em">
                        ...
                        <div class="col3">
                            ...
                            <select multiple="multiple" class="form-control" style="margin: 1em 0" ng-model="selectedOptions">
                        ...
                        <div class="col3">
                            ...
                            <br />
                            <br />
                            <input type="button" class="btn btn-primary" style="float: right;" value="Show Report" ng-click="showReport()" />
                        </div>
                        <div class="col3 last">
                            <br />
                        </div>
