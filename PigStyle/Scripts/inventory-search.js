...
angular.module('accInvApp').controller('accInvModalInstanceCtrl', function ($scope, $loading, $http, $uibModalInstance, $uibModal, modalInfo) {
    ...
    $scope.totalItems = $scope.modalInfo.length;
    $scope.currentPage = 1;
