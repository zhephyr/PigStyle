<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmStoreColorCopierCharges.aspx.vb" Inherits="PigStyle.frmStoreColorCopierCharges" %>
        ...
        <div id="container">
            <div id="header">
                ...
                <div class="text" style="text-align: center">
                    <h1>Store Color Copier Charges</h1>
                </div>
            </div>
            <div id="breadcrumbs">
                ...
                <a href="frmStoreColorCopierCharges.aspx">Copier Charges</a>
            </div>
            <div id="main">
                <div id="nav">
                ...
                <div id="content" style="text-align: center;">
                    <div class="onerow">
                        ...
                        <div class="col1">
                            ...
                            <br />
                            <br />
                            <asp:TextBox ID="txtCopies" runat="server" Width="100%" TabIndex="2" onkeydown="CopiesEnter(event)"></asp:TextBox>
                        </div>
                        <div class="col2">
                            Simplex/ Duplex
                            <br />
                        ...
                        <div class="col2">
                            ...
                            <br />
                            <br />
                            <asp:DropDownList ID="lstJobType" runat="server" Width="100%" TabIndex="5" onchange="MoveToComments(event)">
                                <asp:ListItem></asp:ListItem>
                    ...
                    <div class="onerow" style="text-align:center;">
                        ...
                        <div class="col2">
                            <asp:RadioButton ID="rdSingle" runat="server" Text="SINGLE" GroupName="SideGroup" Checked="true" /><br />
                            <asp:RadioButton ID="rdMultiple" runat="server" Text="MULTIPLE" GroupName="SideGroup" />
                        </div>
                        <div class="col2">
