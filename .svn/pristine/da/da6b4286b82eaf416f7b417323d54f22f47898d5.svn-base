                ...
                <div class="col3" ng-controller="StoreBillingCtrl">
                    ...
                    <script type="text/ng-template" id="storeBillingContent.html">
                        ...
                        <div class="modal-body">
                            <ul>
                                <li>
                                    <a href="frmStoreStandardCopier.aspx">Standard Copier Charges</a>
                                </li>
                                <li>
                                    <a href="frmStoreColorCopierCharges.aspx">Color Copier Charges</a>
                                </li>
                                <li>
                                    <a href="frmStorePrintSupplies.aspx">Store Print Supplies</a>
                                </li>
                                <li>
                                    <a href="frmStorePadCharges.aspx">Store Pad Charges</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col3" ng-controller="OfficeBillingCtrl">
                    ...
                    <script type="text/ng-template" id="officeBillingContent.html">
                        ...
                        <div class="modal-body">
                            <ul>
                                <li>
                                    <a href="frmOfficeStandardCopier.aspx">Standar Copier Charges</a>
                                </li>
                                <li>
                                    <a href="frmOfficeColorCopierCharges.aspx">Color Copier Charges</a>
                                </li>
                                <li>
                                    <a href="frmOfficePaperUsage.aspx">Office Paper Usage</a>
                                </li>
                                <li>
                                    <a href="frmOfficePadCharges.aspx">Office Pad Charges</a>
                                </li>
                            </ul>
                        </div>
                        <div class="modal-footer">
