    ...
    <form id="form1" runat="server" ng-controller="accInvCtrl">
        <div id="container" dw-loading="pallets">
            ...
            <div id="breadcrumbs">
                ...
                <a href="/Programs/Corporate_Accounting/CorpAccProg.aspx">Accounting</a>
                                            ...
                                            <table style="width: 100%; border-bottom: solid #4e95f4">
                                                <tr>
                                                    <td style="text-align: center;">From Date:
                                                        <p class="input-group">
                                                            <input type="text" class="form-control" uib-datepicker-popup="MM/dd/yyyy" ng-model="startDate" is-open="popStart.opened" datepicker-options="dateOptions" close-text="Close" alt-input-formats="'M!/d!/yyyy'" placeholder="MM/DD/YYYY" />
                                                    ...
                                                    <td style="text-align: center;">To Date:
                                                        <p class="input-group">
                                                            <input type="text" class="form-control" uib-datepicker-popup="MM/dd/yyyy" ng-model="endDate" is-open="popEnd.opened" datepicker-options="dataOptions" close-text="Close" alt-input-formats="'M!/d!/yyyy'" placeholder="MM/DD/YYYY" />
                                                            <span class="input-group-btn">
